...
| :--- | :--- | :--- | :--- |
| **Seconds per Day** | 86,400 seconds | **100,000 (10⁵) seconds** | Simplifies division by orders of magnitude |
| **Seconds per Month** | 2,592,000 seconds | **2.5 Million (2.5 × 10⁶) seconds**| Fast mental math for monthly totals |
| **1 Million (10⁶) / 100,000**| 11.57 requests/sec | **10 QPS** | Quick mental baseline |
| **1 Billion (10⁹) / 100,000**| 11,574 requests/sec| **10,000 QPS** | Standard enterprise throughput scale |

### Step-by-Step Mathematical Calculation

1. **Calculate Total Daily Volume**:
   - Given DAU = 100 Million
...
**Average RPS** = (Total Requests per Day) / 86,400 ≈ 2,000,000,000 / 100,000 = 20,000 RPS

3. **Separate Read RPS vs. Write RPS**:
   - If Read:Write ratio is 3:1 (75% reads, 25% writes):

**Read QPS** = 20,000 × 0.75 = 15,000 Read QPS

**Write QPS** = 20,000 × 0.25 = 5,000 Write QPS
