...
- **Functional Requirements**:
  ...
  - Enforce absolute double-entry balance equality: Σ Debits = Σ Credits.
...
- **Non-Functional Requirements**:
  ...
  - High Performance: Low-latency append speeds (< 10 ms) with read-optimized balance projections.
...
|---|---|---|---|
| **Relational RDBMS Shards** | PostgreSQL / Aurora append-only tables | Moderate (~ 5,000 writes/sec) | Standard SQL transaction logs & triggers. |
| **Event-Sourced Store** | Kafka + EventStore DB | Extreme (> 100,000 writes/sec) | Native event-sourcing replaying for balance reconstruction. |
