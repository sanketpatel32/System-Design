...
|---|---|---|---|
| **3x Replication** | Writes 3 complete copies across different AZs | 200% overhead (3.0× multiplier) | High; expensive storage cost for massive scale. |
| **Erasure Coding (8+4)** | Splits object into 8 data blocks + 4 parity blocks; recovers from any 8 blocks | 50% overhead (1.5× multiplier) | Extreme durability (survives 4 simultaneous drive/node losses). |
